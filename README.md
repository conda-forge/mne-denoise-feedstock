...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-mne--denoise-green.svg)](https://anaconda.org/conda-forge/mne-denoise) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/mne-denoise.svg)](https://anaconda.org/conda-forge/mne-denoise) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/mne-denoise.svg)](https://anaconda.org/conda-forge/mne-denoise) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/mne-denoise.svg)](https://anaconda.org/conda-forge/mne-denoise) |

Installing mne-denoise
======================

Installing `mne-denoise` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search mne-denoise --channel conda-forge

# List packages depending on `mne-denoise`:
mamba repoquery whoneeds mne-denoise --channel conda-forge
...
Updating mne-denoise-feedstock
==============================

If you would like to improve the mne-denoise recipe or build a new
...
Note that all branches in the conda-forge/mne-denoise-feedstock are
...
* [@BabaSanfour](https://github.com/BabaSanfour/)
